...
public class FunctionAndMethodExample {
    ...
    public static void main(String[] args) {
        ...
        // Check if input is a valid integer<Question ID="1" Shortcut="Q1" Order="" ElementType="question" QuestionType="closed" MinResponse="1" MaxResponse="1" Anonymity="1" AllowDK="1" Translated="0" >
        if (!sc.hasNextInt()) {
